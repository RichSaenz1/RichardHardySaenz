...
(function () {
  ...
  function detectProduct() {
    ...
    if (path.indexOf("thank-you/audit") !== -1 || path.indexOf("whatsapp-automation-guide") !== -1 || product.indexOf("whatsapp") !== -1 || products.indexOf("whatsapp") !== -1 || path.indexOf("step-2/audit") !== -1 || path.indexOf("step-2\\audit") !== -1) return "whatsappAutomationGuide";
    if (path.indexOf("thank-you/learn") !== -1 || path.indexOf("rollout-timeline") !== -1 || product.indexOf("rollout") !== -1 || path.indexOf("step-2/learn") !== -1) return "rolloutTimeline";
    if (path.indexOf("thank-you/build") !== -1 || path.indexOf("service-business-prompts") !== -1 || product.indexOf("service-business-prompts") !== -1 || path.indexOf("step-2/build") !== -1) return "serviceBusinessPrompts";
