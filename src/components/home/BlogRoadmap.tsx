    ...
    <div className="grid gap-8 lg:grid-cols-[0.72fr_1.28fr] lg:items-start">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {t.topics.map(([title, body], index) => (
          <article
            key={title}
            className="group rounded-[1.35rem] border border-borderblue bg-white p-6 shadow-[0_18px_54px_rgba(6,27,51,0.055)] transition hover:-translate-y-1 hover:border-navy/70"
          >
