      ...
      <div className="grid gap-6 lg:grid-cols-5 lg:gap-5">
        {t.home.journey.steps.map(([title, text], index) => {
          ...
          return (
            ...
            >
              <div className="absolute left-0 top-0 z-10 grid h-12 w-12 place-items-center rounded-full border border-borderblue bg-white text-sm font-medium text-navy shadow-[0_16px_44px_rgba(13,43,69,0.09)] lg:left-1/2 lg:top-6 lg:-translate-x-1/2">
