  ...
  es: {
    ...
    booking: {
      ...
      next: [
        ...
        ["Revisión del equipo", "La solicitud se revisa manualmente y el equipo confirma los detalles."],
  ...
  en: {
    ...
    booking: {
      ...
      next: [
        ...
        ["Team review", "The request is reviewed manually and the team confirms the details."],
